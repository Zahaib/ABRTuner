...
reset
set term pngcairo size 1280,480 font ",16"
...
plot 'brcandles.dat' using 1:4:xticlabels(2) linetype -3 notitle,\
     '' using ($1-0.15):4:3:7:6 with candlesticks linetype 1 lw 3 title 'Avg. bitrate' whiskerbars,\
     '' using ($1-0.15):5:5:5:5 with candlesticks linetype -1 lw 3 notitle,\
