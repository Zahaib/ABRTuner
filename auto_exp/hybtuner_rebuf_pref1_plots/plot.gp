...
set xtics 1000
plot 'cdf_bitrate_rebuf1-online-tuner.txt' u 2:1 with lines dt 5 lw 4 t 'Rebuf 1', \
...
set yrange [60:100]
set key bottom right
plot 'cdf_rebuf_rebuf1-online-tuner.txt' u 2:1 with lines dt 5 lw 4 t 'Rebuf 1', \
...
set key bottom right
set xrange [0:1000]
plot 'cdf_change_rebuf1-online-tuner.txt' u 2:1 with lines dt 5 lw 4 t 'Rebuf 1', \
...
set key bottom right
set xrange [-0.5:4.3]
plot 'cdf_qoe_rebuf1-online-tuner.txt' u 2:1 with lines dt 5 lw 4 t 'Rebuf 1', \
