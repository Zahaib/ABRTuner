...
'../tuner_pensieve_mpc_plots/cdf_bitrate_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 4300, 1', \
'cdf_bitrate_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 8600, 1'
...
'../tuner_pensieve_mpc_plots/cdf_rebuf_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 4300, 1', \
'cdf_rebuf_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 8600, 1'
...
#set yrange [85:100]
set key bottom right
plot 'cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner orig', \
'../switchlock_plots/cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'../tuner_pensieve_mpc_plots/cdf_change_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 4300, 1', \
'cdf_change_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 8600, 1'
...
'../switchlock_plots/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'../tuner_pensieve_mpc_plots/cdf_qoe_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 4300, 1', \
'cdf_qoe_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 8600, 1'
...
set key bottom right
set xrange[-0.25:4.3]
plot 'cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner orig', \
'../switchlock_plots/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'cdf_qoe_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve 8600, 1'
