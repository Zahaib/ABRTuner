...
set ylabel 'CDF'
set key top left
plot '../switchlock_plots/cdf_bitrate_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_bitrate_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'cdf_bitrate_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 4', \
'cdf_bitrate_orig-online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner orig'
...
plot '../switchlock_plots/cdf_rebuf_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_rebuf_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'cdf_rebuf_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 4', \
'cdf_rebuf_orig-online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner orig'
...
#set yrange [85:100]
set key bottom right
plot '../switchlock_plots/cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'cdf_change_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 4', \
...
set key bottom right
set xrange[-0.25:4.3]
plot '../switchlock_plots/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 2', \
'../switchlock_plots_4/cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 3', \
'cdf_qoe_online-tuner.txt' u 2:1 with lines lw 3 t 'ABRTuner lock 4', \
'../tuner_pensieve_mpc_plots/cdf_qoe_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Pensieve'
