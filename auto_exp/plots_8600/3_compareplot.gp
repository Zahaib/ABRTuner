...
'cdf_change_robustmpc.txt' u 2:1 with lines lw 3 t '8600 MPC', \
...
plot '../plots/cdf_bitrate_percentage_diff_robustmpc.txt' u 2:1 with lines lw 3 t 'MPC', \
'../plots/cdf_bitrate_percentage_diff_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Penseive', \
...
set yzeroaxis lt 1 lw 3 lc rgb 'black'
set xrange [-2:8]
plot '../plots/cdf_rebuf_percentage_diff_robustmpc.txt' u 2:1 with lines lw 3 t 'MPC', \
'../plots/cdf_rebuf_percentage_diff_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Penseive', \
...
set key top left
set yzeroaxis lt 1 lw 3 lc rgb 'black'
plot '../plots/cdf_change_percentage_diff_robustmpc.txt' u 2:1 with lines lw 3 t 'MPC', \
'../plots/cdf_change_percentage_diff_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Penseive', \
...
set yzeroaxis lt 1 lw 3 lc rgb 'black'
set xrange [-50:50]
plot '../plots/cdf_qoe_percentage_diff_robustmpc.txt' u 2:1 with lines lw 3 t 'MPC', \
'../plots/cdf_qoe_percentage_diff_pensieve-pensvid.txt' u 2:1 with lines lw 3 t 'Penseive', \
