...
REBUF_PENALTY = 4.3 #100000.0 #4.3  # 1 sec rebuffering -> this number of Mbps
SMOOTH_PENALTY = 1.0 #1
...
#NN_MODEL = '../rl_server/results/default_ourtrain_nn_model_ep_140000.ckpt'
#NN_MODEL = '../rl_server/results/entropy_5_1000/nn_model_ep_100000.ckpt'
# video chunk sizes
...
def run(server_class=HTTPServer, port=8333, log_file_path=LOG_FILE):
    ...
    with tf.Session() as sess, open(log_file_path, 'wb') as log_file:
        ...
        actor = a3cweird.ActorNetwork(sess,
                                 state_dim=[S_INFO, S_LEN], action_dim=A_DIM,
                                 learning_rate=ACTOR_LR_RATE)
        critic = a3cweird.CriticNetwork(sess,
        ...
        if nn_model is not None:  # nn_model is the path to file
            print >> sys.stderr, "Restoring NN params\n"
